      ...
      <main className="flex flex-col flex-1 items-center text-center max-w-7xl pt-15 mx-auto w-full p-6">
        ...
        <section className="px-4 text-center w-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 place-items-center max-w-6xl mx-auto">
            <div className="bg-teal-500 rounded-2xl p-3 w-full max-w-xs transform transition-transform duration-300 hover:scale-105">
              <img
                src="/images/doctor-with-medical-services.png"
                alt="Feature 1"
                className="w-64 mx-auto"
              />
              <p className="text-teal-950 font-semibold text-2xl">Chatbot Konsultasi</p>
            </div>
            <div className="bg-teal-500 rounded-2xl p-3 w-full max-w-xs transform transition-transform duration-300 hover:scale-105">
              <img
                ...
                className="w-64 mx-auto"
              />
              <p className="text-teal-950 font-semibold text-2xl">Deteksi Citra Gejala</p>
            </div>
            <div className="bg-teal-500 rounded-2xl p-3 w-full max-w-xs transform transition-transform duration-300 hover:scale-105">
              <img
                ...
                className="w-64 mx-auto"
              />
              <p className="text-teal-950 font-semibold text-2xl">Rekomendasi Tindakan</p>
            </div>
          </div>
        </section>
      </main>
